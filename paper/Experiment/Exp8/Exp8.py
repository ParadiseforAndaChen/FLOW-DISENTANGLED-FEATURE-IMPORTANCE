...
txt_dir_loco = "Exp_SIM/1000/phi_logs/loco_phi_logs"
csv_path_loco = "Exp_SIM/1000/summary/loco_summary.csv"


txt_dir_nloco = "Exp_SIM/1000/phi_logs/nloco_phi_logs"
csv_path_nloco = "Exp_SIM/1000/summary/nloco_summary.csv"

txt_dir_dloco = "Exp_SIM/1000/phi_logs/dloco_phi_logs"
csv_path_dloco = "Exp_SIM/1000/summary/dloco_summary.csv"

txt_dir_dfi = "Exp_SIM/1000/phi_logs/dfi_phi_logs"
csv_path_dfi = "Exp_SIM/1000/summary/dfi_summary.csv"


txt_dir_cpi = "Exp_SIM/1000/phi_logs/cpi_phi_logs"
csv_path_cpi = "Exp_SIM/1000/summary/cpi_summary.csv"
...
for run in range(1, num_runs + 1):
    ...
    from Inference.data import Exp_SIM
    ...
    for j, (phi_j, se_j) in enumerate(zip(phi_0_loco, std_0_loco)):
        print(f"{j:>3d}\t{phi_j: .4f}\t{se_j: .4f}")
    print(f"LOCO_0总和: {D* np.mean(phi_0_loco)}")
    ...
    for j, (phi_j, se_j) in enumerate(zip(phi_0_nloco, std_0_nloco)):
        print(f"{j:>3d}\t{phi_j: .4f}\t{se_j: .4f}")
    print(f"nLOCO_0总和: {D* np.mean(phi_0_nloco)}")
    ...
    for j, (phi_j, se_j) in enumerate(zip(phi_0_dloco, std_0_dloco)):
        print(f"{j:>3d}\t{phi_j: .4f}\t{se_j: .4f}")
    print(f"dLOCO_0总和: {D* np.mean(phi_0_dloco)}")
    ...
    for j, (phi_j, se_j) in enumerate(zip(phi_x_dfi, std_x_dfi)):
        print(f"{j:>3d}\t{phi_j: .4f}\t{se_j: .4f}")
    print(f"DFI_X总和: {D* np.mean(phi_x_dfi)}")
    ...
    for j, (phi_j, se_j) in enumerate(zip(phi_x_cpi, std_x_cpi)):
        print(f"{j:>3d}\t{phi_j: .4f}\t{se_j: .4f}")
    print(f"CPI_X总和: {D* np.mean(phi_x_cpi)}")
